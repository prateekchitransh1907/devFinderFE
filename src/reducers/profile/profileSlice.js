...
const profileSlice = createSlice({
    ...
    reducers: {
        ...
        getProfileError: (state, action) => {
            ...
            state.getProfile.error = action.payload || 'Unable to fetch profile. Please try again.';
        },
        ...
        editProfileError: (state, action) => {
            ...
            state.editProfile.error = action.payload || 'Unable to edit profile. Please try again.';
        },
    },
})

export const { getProfilePending, getProfileSuccess, getProfileError, editProfilePending, editProfileSuccess, editProfileError } = profileSlice.actions;
